    ...
    public void run() {
        try {
            while (true) {
                ...
                sPlottwist.acquire();
                //SECCION CRITICA
                LugoSancio_SOP_1.inPlottwist = LugoSancio_SOP_1.append(plottwistGenerico,LugoSancio_SOP_1.bPlottwist,LugoSancio_SOP_1.kPlottwist,LugoSancio_SOP_1.inPlottwist);
