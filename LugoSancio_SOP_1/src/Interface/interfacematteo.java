 ...
 * @author ernes
 */
public class interfacematteo extends javax.swing.JFrame {

    /**
     * Creates new form Interface
     */
    public interfacematteo() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(interfacematteo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new interfacematteo().setVisible(true);
            }
        });
    }
